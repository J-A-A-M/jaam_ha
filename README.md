...
- **Система тривог**: 13 окремих бінарних сенсорів для різних типів загроз, зокрема жовтий та червоний рівень тривоги (прошивка 5.1+)
...
Платформа | Опис
-- | --
`binary_sensor` | Статус WebSocket з'єднання та 13 сенсорів типів тривог
...
- **Бінарні сенсори**: Статус WebSocket з'єднання + 13 сенсорів типів тривог
...
13 окремих бінарних сенсорів для різних типів загроз (оновлюються в реальному часі):

- **Повітряна тривога (Застаріло)**: Загальна повітряна тривога. Замінена сенсорами **Жовтий рівень тривоги** та **Червоний рівень тривоги** — новий формат розрізняє рівень небезпеки, тому цей сенсор залишено лише для сумісності зі старими автоматизаціями
- **Жовтий рівень тривоги**: Низький рівень повітряної тривоги (потребує прошивку 5.1+)
- **Червоний рівень тривоги**: Високий рівень повітряної тривоги, основний тригер (потребує прошивку 5.1+)
...
> **Примітка**: На прошивках старіших за 5.1 сенсори жовтого/червоного рівня тривоги не створюються (адаптивна поведінка, як і для інших апаратно-залежних сенсорів). Після оновлення прошивки до 5.1+ вони з'являться автоматично, без перестворення інтеграції.
