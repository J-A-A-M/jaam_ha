"""Device info utilities for jaam_ha."""
...
def create_device_info(
    ...
    return DeviceInfo(
        ...
        name=name or "JAAM Home Assistant Integration",
        manufacturer=manufacturer or "JAAM Home Assistant Integration",
...
def get_device_identifiers(config_entry: ConfigEntry) -> set[tuple[str, str]]:
    ...
    Example:
        ...
        >>> # Returns: {('jaam_ha', 'entry_id_value')}
    """
