...
async def async_setup_entry(
    ...
    async_add_entities([JaamHALampLight(coordinator)])
...
class JaamHALampLight(JaamHAEntity, LightEntity):
    ...
    def __init__(
        ...
        # Initialize parent classes - JaamHAEntity handles unique_id generation
        JaamHAEntity.__init__(self, coordinator, entity_description)
