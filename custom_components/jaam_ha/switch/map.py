"""Map enabled switch for jaam_ha."""
...
class JaamHAMapSwitch(SwitchEntity, JaamHAEntity):
    """Map enabled switch entity."""
    ...
    async def async_turn_on(self, **kwargs) -> None:
        ...
        await client.async_set_map_enabled(True)
        await self.coordinator.async_request_refresh()

    async def async_turn_off(self, **kwargs) -> None:
        """Turn the switch off."""
        client = self.coordinator.config_entry.runtime_data.client
        await client.async_set_map_enabled(False)
        await self.coordinator.async_request_refresh()
