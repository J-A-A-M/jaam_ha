...
from custom_components.jaam_ha.api import JaamHAApiClientAuthenticationError, JaamHAApiClientError
...
class JaamHADataUpdateCoordinator(DataUpdateCoordinator):
    """
