# Getting Started with JAAM Home Assistant Integration

This guide will help you install and set up the JAAM Home Assistant Integration custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/J-A-A-M/jaam_ha`
6. Set category to "Integration"
7. Click "Add"
8. Find "JAAM Home Assistant Integration" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/J-A-A-M/jaam_ha/releases)
2. Extract the `jaam_ha` folder from the archive
3. Copy it to `custom_components/jaam_ha/` in your Home Assistant configuration directory
...
4. Select entities from "JAAM Home Assistant Integration"

Example entities card:

```yaml
type: entities
title: JAAM Home Assistant Integration
entities:
...
- Report issues at [GitHub Issues](https://github.com/J-A-A-M/jaam_ha/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/J-A-A-M/jaam_ha/discussions)
