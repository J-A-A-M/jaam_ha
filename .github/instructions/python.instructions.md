...
- Files: `snake_case.py`
- Classes: `PascalCase` prefixed with `JaamHA`
...
- Inherit from both platform entity and `JaamHAEntity` (order matters)
...
from custom_components.jaam_ha.sensor import async_setup_entry
...
**Config entry data:** `entry_data: JaamHAData = hass.data[DOMAIN][entry.entry_id]`
