...
**File:** `custom_components/jaam_ha/services.yaml`
...
Create `custom_components/jaam_ha/service_actions/[action_name].py`:

```python
"""[Action name] service action for JAAM Home Assistant Integration."""
...
**File:** `custom_components/jaam_ha/__init__.py`
...
**File:** `custom_components/jaam_ha/const.py`
...
3. Find service action: `jaam_ha.[action_name]`
...
- **Domain:** `jaam_ha`
- **Service actions directory:** `custom_components/jaam_ha/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/jaam_ha/services.yaml` (legacy filename)
- **Icons:** `custom_components/jaam_ha/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/jaam_ha/translations/*.json` under `services` key (legacy)
