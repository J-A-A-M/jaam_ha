...
- Inherit from `JaamHAEntity` and platform base class
...
- Entity: `custom_components/jaam_ha/[platform]/[entity_name].py`
- Platform: `custom_components/jaam_ha/[platform]/__init__.py`
