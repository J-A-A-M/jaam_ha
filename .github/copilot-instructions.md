...
- `entity/` - Base entity class (`JaamHAEntity`)
...
- All entities inherit: `(PlatformEntity, JaamHAEntity)` - order matters for MRO
...
- Adjust log level: `custom_components.jaam_ha: debug` in `config/configuration.yaml`
